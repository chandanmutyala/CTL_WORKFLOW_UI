		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Register Missing Scopes",
									"targetURL": "#commnealocalizationuiwf-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commnealocalizationuiwf-display": {
								"semanticObject": "commnealocalizationuiwf",
								"action": "display",
								"description": "Register Missing Scopes",
								"title": "Register Missing Scopes",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mnea.localizationuiwf",
									"url": sap.ui.require.toUrl("com/mnea/localizationuiwf")
								}
							}
						}
					}
