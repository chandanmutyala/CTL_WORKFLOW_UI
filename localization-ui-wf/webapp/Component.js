sap.ui.define(
  [
    ...
    "sap/ui/Device",
    "com/mnea/localizationuiwf/model/models",
  ],
  function (UIComponent, Device, models) {
    "use strict";

    return UIComponent.extend(
      "com.mnea.localizationuiwf.Component",
      {
        metadata: {
          manifest: "json",
        },
        ...
        _getWorkflowRuntimeBaseURL: function () {  
          ...
          return `/${appPath}/bpmworkflowruntime/v1`
        ...
        completeTask: function (approvalStatus, outcome) {
          
          this.getModel("context").setProperty("/approved", approvalStatus);
          this._patchTaskInstance(outcome);
          this._refreshTaskList();
        },

        _patchTaskInstance: function (outcome) {
          var data = {
            status: "COMPLETED",
